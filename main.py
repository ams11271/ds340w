...
X_train = create_features(X_train, y_train, numerical_columns, categorical_columns)
X_test = create_features(X_test, y_test, numerical_columns, categorical_columns)
X_val = create_features(X_val, y_val, numerical_columns, categorical_columns)
